...
experiment_id = "521370518736201379"
rid = "960bd492ee04417b88172fc42180a8e2"
...
if __name__ == '__main__': 
    ...
    """ with R.start(experiment_id=experiment_id, recorder_id=rid, resume=True):
        ...
        fig = analysis_position.report_graph(report_normal_df,show_notebook=False)

        chart = fig[0]

        chart.write_html("my_plot.html") """

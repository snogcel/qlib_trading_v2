...
__all__ = ["CustomSingleAssetOrderExecutionSimple"]

import warnings

class CustomSingleAssetOrderExecutionSimple(Simulator[Order, SAOEExtendedState, float]):
    ...
    def __init__(
        ...
        print(self.order)
        #print(self.ticks_for_order)
        #print(self.feature_columns_today)
    ...
    def get_state(self) -> SAOEExtendedState:
        return SAOEExtendedState(
            order=self.order,
